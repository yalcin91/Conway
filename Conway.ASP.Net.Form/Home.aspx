            ...
            <div class="row1">
                ...
                <div class="meubel-rechts">
                    <div class="boven">
                        ...
                        <asp:Label runat="server" ID="lbl_11" class="textVerticalRechts"></asp:Label></div>
                    <div class="boven">
                        <asp:Label runat="server" ID="lbl_12_Prix" class="textVerticalRechtseuro"></asp:Label>
                        <asp:Label runat="server" ID="lbl_12" class="textVerticalRechts"></asp:Label></div>
                    <div class="boven">
                        <asp:Label runat="server" ID="lbl_13_Prix" class="textVerticalRechtseuro"></asp:Label>
                        <asp:Label runat="server" ID="lbl_13" class="textVerticalRechts"></asp:Label></div>
                    <div class="boven">
                        <asp:Label runat="server" ID="lbl_14_Prix" class="textVerticalRechtseuro"></asp:Label>
                        <asp:Label runat="server" ID="lbl_14" class="textVerticalRechts"></asp:Label></div>
                    <div class="boven">
                        <asp:Label runat="server" ID="lbl_15_Prix" class="textVerticalRechtseuro"></asp:Label>
                        <asp:Label runat="server" ID="lbl_15" class="textVerticalRechts"></asp:Label></div>
                    <div class="boven">
                        <asp:Label runat="server" ID="lbl_16_Prix" class="textVerticalRechtseuro"></asp:Label>
                        <asp:Label runat="server" ID="lbl_16" class="textVerticalRechts"></asp:Label></div>
                    <div class="boven">
                        <asp:Label runat="server" ID="lbl_17_Prix" class="textVerticalRechtseuro"></asp:Label>
                        <asp:Label runat="server" ID="lbl_17" class="textVerticalRechts"></asp:Label></div>
                    <div class="boven">
                        <asp:Label runat="server" ID="lbl_18_Prix" class="textVerticalRechtseuro"></asp:Label>
                        <asp:Label runat="server" ID="lbl_18" class="textVerticalRechts"></asp:Label></div>
                    <div class="boven">
                        <asp:Label runat="server" ID="lbl_19_Prix" class="textVerticalRechtseuro"></asp:Label>
                        <asp:Label runat="server" ID="lbl_19" class="textVerticalRechts"></asp:Label></div>
                    <div class="boven">
                        <asp:Label runat="server" ID="lbl_20_Prix" class="textVerticalRechtseuro"></asp:Label>
                        <asp:Label runat="server" ID="lbl_20" class="textVerticalRechts"></asp:Label></div>
                    ...
                    <div class="boven">
                        ...
                        <asp:Label runat="server" ID="lbl_1" class="textVerticalRechts"></asp:Label></div>
                    <div class="boven">
                        <asp:Label runat="server" ID="lbl_2_Prix" class="textVerticalRechtseuro"></asp:Label>
                        <asp:Label runat="server" ID="lbl_2" class="textVerticalRechts"></asp:Label></div>
                    <div class="boven">
                        <asp:Label runat="server" ID="lbl_3_Prix" class="textVerticalRechtseuro"></asp:Label>
                        <asp:Label runat="server" ID="lbl_3" class="textVerticalRechts"></asp:Label></div>
                    <div class="boven">
                        <asp:Label runat="server" ID="lbl_4_Prix" class="textVerticalRechtseuro"></asp:Label>
                        <asp:Label runat="server" ID="lbl_4" class="textVerticalRechts"></asp:Label></div>
                    <div class="boven">
                        <asp:Label runat="server" ID="lbl_5_Prix" class="textVerticalRechtseuro"></asp:Label>
                        <asp:Label runat="server" ID="lbl_5" class="textVerticalRechts"></asp:Label></div>
                    <div class="boven">
                        <asp:Label runat="server" ID="lbl_6_Prix" class="textVerticalRechtseuro"></asp:Label>
                        <asp:Label runat="server" ID="lbl_6" class="textVerticalRechts"></asp:Label></div>
                    <div class="boven">
                        <asp:Label runat="server" ID="lbl_7_Prix" class="textVerticalRechtseuro"></asp:Label>
                        <asp:Label runat="server" ID="lbl_7" class="textVerticalRechts"></asp:Label></div>
                    <div class="boven">
                        <asp:Label runat="server" ID="lbl_8_Prix" class="textVerticalRechtseuro"></asp:Label>
                        <asp:Label runat="server" ID="lbl_8" class="textVerticalRechts"></asp:Label></div>
                    <div class="boven">
                        <asp:Label runat="server" ID="lbl_9_Prix" class="textVerticalRechtseuro"></asp:Label>
                        <asp:Label runat="server" ID="lbl_9" class="textVerticalRechts"></asp:Label></div>
                    <div class="boven">
                        <asp:Label runat="server" ID="lbl_10_Prix" class="textVerticalRechtseuro"></asp:Label>
                        <asp:Label runat="server" ID="lbl_10" class="textVerticalRechts"></asp:Label></div>
                ...
                <div class="info-kolom">
                    <div class="infoKolom1" aria-orientation="vertical">
                        ...
                        <asp:Button runat="server" Text="Niet Actief" CssClass="btn_NietActief"/><br />
                        <asp:Button runat="server" Text="20" CssClass="btn_20"/><br />
                        <asp:Button runat="server" Text="21 - 46" CssClass="btn_21-46"/><br />
                        <asp:Button runat="server" Text="47 - 60" CssClass="btn_47-60"/><br />
                    </div>
